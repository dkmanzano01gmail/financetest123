...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      transactions: {
        Row: {
          ...
          importance_level: Database["public"]["Enums"]["importance_level"] | null;
          importance_status: Database["public"]["Enums"]["importance_status"] | null;
          ...
          suggested_importance_level: Database["public"]["Enums"]["importance_level"] | null;
          type: Database["public"]["Enums"]["transaction_type"];
          updated_at: string;
          workspace_id: string;
          year: number;
    ...
    Enums: {
      ...
      balance_snapshot_type: "initial" | "manual_current" | "reconciliation_check" | "adjustment";
      importance_level: "essential" | "important" | "flexible" | "superfluous";
      importance_status: "suggested" | "confirmed" | "manually_changed" | "needs_review";
